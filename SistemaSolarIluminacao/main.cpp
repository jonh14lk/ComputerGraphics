...
struct sun
{
  ...
  void illuminate()
  {
    GLfloat mat_difusa[] = {1.0, 0.5, 1.0, 1.0};
    GLfloat mat_especular[] = {1.0, 1.0, 0.5, 1.0};
    GLfloat mat_brilho[] = {90.0};
    GLfloat posicao_luz[] = {0.0, 0.0, 0.0, 1.0};
...
void init()
{
  ...
  glEnable(GL_LIGHT0);              // ativar um ponto de luz denominado GL_LIGHT0
  glEnable(GL_COLOR_MATERIAL);      // ativar color tracking (para definir cores de faces)
}
